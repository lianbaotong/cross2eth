...
type RelayerConfig struct {
	...
	SignViaHsm                bool               `protobuf:"varint,10,opt,name=signViaHsm,proto3" json:"signViaHsm,omitempty"`
	Secp256K1KeyIndex4Eth     int32              `protobuf:"varint,11,opt,name=secp256k1KeyIndex4Eth,proto3" json:"secp256k1KeyIndex4Eth,omitempty"`
	Secp256K1KeyIndex4Chain33 int32              `protobuf:"varint,12,opt,name=secp256k1KeyIndex4Chain33,proto3" json:"secp256k1KeyIndex4Chain33,omitempty"`
	Chain33PubKey             string             `protobuf:"bytes,13,opt,name=chain33PubKey,proto3" json:"chain33PubKey,omitempty"`
	EthereumValidator         string             `protobuf:"bytes,14,opt,name=ethereumValidator,proto3" json:"ethereumValidator,omitempty"`
	Chain33Passpin            string             `protobuf:"bytes,15,opt,name=chain33Passpin,proto3" json:"chain33Passpin,omitempty"`
	EthereumPasspin           string             `protobuf:"bytes,16,opt,name=ethereumPasspin,proto3" json:"ethereumPasspin,omitempty"`
	Deploy4ProductEnv         bool               `protobuf:"varint,17,opt,name=deploy4productEnv,proto3" json:"deploy4productEnv,omitempty"`
}
...
func (x *RelayerConfig) GetChain33Passpin() string {
	if x != nil {
		return x.Chain33Passpin
	}
	return ""
}

func (x *RelayerConfig) GetEthereumPasspin() string {
	if x != nil {
		return x.EthereumPasspin
	}
	return ""
}

func (x *RelayerConfig) GetDeploy4ProductEnv() bool {
	if x != nil {
		return x.Deploy4ProductEnv
	}
	return false
}
...
var file_config_proto_rawDesc = []byte{
	...
	0x33, 0x22, 0xcb, 0x05, 0x0a, 0x0d, 0x52, 0x65, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x43, 0x6f, 0x6e,
	...
	,
